...
public class OrderService {
    ...
    @SimplyTimed(name = "order_svc:spl50_order_process_time", description = "A measure of how long it takes to process an order", unit = MetricUnits.MILLISECONDS)
    ...
    public String processOrder() {
        ...
        return "Welcome version 1.2. Thank you for your order! Your order id is " + getRandom(1, 10000) + "\n";
    }
